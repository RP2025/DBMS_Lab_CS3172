...
-- Foreign keys: cust_id references customer on delete cascade, truck_no references truck
-- on delete set null, destination references city.
...
VALUES
    ...
    (12039,1503,738,18002,'Bangalore','2021-08-08'),
